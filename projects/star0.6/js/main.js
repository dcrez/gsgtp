...
require.config({
    ...
    paths: {
        logic: 'base1',
        fontawesome: 'https://use.fontawesome.com/b676143643',
        ...
        nprogress: 'https://unpkg.com/nprogress@0.2.0/nprogress',
        polyfill: 'https://cdn.polyfill.io/v2/polyfill'
    }
});

require(['jquery','popper', 'bootstrap','handlebars', 'polyfill','nprogress'], function() {
    //"use strict";
