    ...
    <section id="login" class="col-lg-6" v-if="showLogin">
      ...
      <form @submit.prevent class="pt-2 col-sm-10 mx-auto">
        ...
        <div class="form-row d-flex">
          <div class="mt-2 col-sm-12 mx-auto"><button class="btn btn-primary btn-block" @click="login">Login</button></div>
    ...
    <section id="createProfile" class="col-lg-6" v-if="showCreate">
      ...
      <form @submit.prevent class="pt-2">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="password" class="form-control " placeholder="***************" v-model.trim="createProfile.password">
          </div>
        </div>
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="student" value="true" v-model.trim="createProfile.student">
  <label class="form-check-label" for="parent">Student</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="mentor" value="true" v-model.trim="createProfile.volunteer">
  <label class="form-check-label" for="parent">Volunteer</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="teacher" value="true" v-model.trim="createProfile.teacher">
